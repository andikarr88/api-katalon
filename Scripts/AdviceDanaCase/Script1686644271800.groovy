...
signatureResponse = WS.sendRequest(findTestObject('Postman/Advice/GET SIGNATURE SERVICE - dana Advice Payment'))
...
danaAdviceResponse = WS.sendRequest(findTestObject('Postman/Advice/dana Payment Advice'))
