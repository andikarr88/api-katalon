...
signatureResponse = WS.sendRequest(findTestObject('Postman/emoney/opendenom Success/Saving/GET SIGNATURE SERVICE -  - emoney dana open denom payment'))
...
danaPaymentResponse = WS.sendRequest(findTestObject('Postman/emoney/opendenom Success/Saving/dana payment'))
