...
signatureResponse = WS.sendRequest(findTestObject('Postman/emoney/opendenom Success/Saving/GET SIGNATURE SERVICE -  - emoney linkaja open denom payment'))
...
danaPaymentResponse = WS.sendRequest(findTestObject('Postman/emoney/opendenom Success/Saving/linkaja payment'))
