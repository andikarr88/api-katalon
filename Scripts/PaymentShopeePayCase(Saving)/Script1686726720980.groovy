...
signatureResponse = WS.sendRequest(findTestObject('Postman/emoney/opendenom Success/Saving/GET SIGNATURE SERVICE -  - emoney shopeepay open denom payment'))
...
danaPaymentResponse = WS.sendRequest(findTestObject('Postman/emoney/opendenom Success/Saving/shopeepay payment'))
