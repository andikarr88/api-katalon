...
signatureResponse = WS.sendRequest(findTestObject('Postman/Advice/GET SIGNATURE SERVICE - linkaja Advice Payment'))
...
danaAdviceResponse = WS.sendRequest(findTestObject('Postman/Advice/link Payment Advice'))
