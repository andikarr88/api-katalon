...
signatureResponse = WS.sendRequest(findTestObject('Postman/Advice/GET SIGNATURE SERVICE - Gopay Advice Payment'))
...
danaAdviceResponse = WS.sendRequest(findTestObject('Postman/Advice/gopay Payment Advice'))
