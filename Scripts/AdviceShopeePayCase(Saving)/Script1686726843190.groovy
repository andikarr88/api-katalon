...
signatureResponse = WS.sendRequest(findTestObject('Postman/Advice/GET SIGNATURE SERVICE - shopeepay Advice Payment'))
...
danaAdviceResponse = WS.sendRequest(findTestObject('Postman/Advice/shopeepay Payment Advice'))
