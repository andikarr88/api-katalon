...
signatureResponse = WS.sendRequest(findTestObject('Postman/Advice/Saving/GET SIGNATURE SERVICE - linkaja Advice Payment'))
...
danaAdviceResponse = WS.sendRequest(findTestObject('Postman/Advice/Saving/link Payment Advice'))
