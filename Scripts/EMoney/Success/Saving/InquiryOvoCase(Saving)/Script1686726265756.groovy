...
signatureResponse = WS.sendRequest(findTestObject('Postman/emoney/opendenom Success/Saving/GET SIGNATURE SERVICE -  emoney ovo open denom inquiry'))
...
danaInquiryResponse = WS.sendRequest(findTestObject('Postman/emoney/opendenom Success/Saving/ovo inquiry'))
