...
signatureResponse = WS.sendRequest(findTestObject('Postman/Advice/Saving/GET SIGNATURE SERVICE - ovo Advice Payment'))
...
danaAdviceResponse = WS.sendRequest(findTestObject('Postman/Advice/Saving/ovo Payment Advice'))
