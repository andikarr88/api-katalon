...
signatureResponse = WS.sendRequest(findTestObject('Postman/Advice/Checking/GET SIGNATURE SERVICE - Gopay Advice Payment'))
...
danaAdviceResponse = WS.sendRequest(findTestObject('Postman/Advice/Checking/gopay Payment Advice'))
