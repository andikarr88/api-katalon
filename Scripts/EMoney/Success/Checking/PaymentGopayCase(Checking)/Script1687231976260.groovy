...
signatureResponse = WS.sendRequest(findTestObject('Postman/emoney/opendenom Success/Checking/GET SIGNATURE SERVICE -  - emoney gopay open denom payment'))
...
danaPaymentResponse = WS.sendRequest(findTestObject('Postman/emoney/opendenom Success/Checking/gopay payment'))
