...
signatureResponse = WS.sendRequest(findTestObject('Postman/Advice/Checking/GET SIGNATURE SERVICE - linkaja Advice Payment'))
...
danaAdviceResponse = WS.sendRequest(findTestObject('Postman/Advice/Checking/link Payment Advice'))
