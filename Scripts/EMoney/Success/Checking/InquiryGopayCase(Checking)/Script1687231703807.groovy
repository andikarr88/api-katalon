...
signatureResponse = WS.sendRequest(findTestObject('Postman/emoney/opendenom Success/Checking/GET SIGNATURE SERVICE -  emoney gopay open denom inquiry'))
...
danaInquiryResponse = WS.sendRequest(findTestObject('Postman/emoney/opendenom Success/Checking/gopay inquiry'))
