...
signatureResponse = WS.sendRequest(findTestObject('Postman/Advice/Checking/GET SIGNATURE SERVICE - shopeepay Advice Payment'))
...
danaAdviceResponse = WS.sendRequest(findTestObject('Postman/Advice/Checking/shopeepay Payment Advice'))
