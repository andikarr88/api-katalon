...
signatureResponse = WS.sendRequest(findTestObject('Postman/emoney/opendenom Success/Checking/GET SIGNATURE SERVICE -  emoney ovo open denom inquiry'))
...
danaInquiryResponse = WS.sendRequest(findTestObject('Postman/emoney/opendenom Success/Checking/ovo inquiry'))
