...
signatureResponse = WS.sendRequest(findTestObject('Postman/Advice/Checking/GET SIGNATURE SERVICE - ovo Advice Payment'))
...
danaAdviceResponse = WS.sendRequest(findTestObject('Postman/Advice/Checking/ovo Payment Advice'))
