...
signatureResponse = WS.sendRequest(findTestObject('Postman/emoney/opendenom Success/Checking/GET SIGNATURE SERVICE -  - emoney linkaja open denom payment'))
...
danaPaymentResponse = WS.sendRequest(findTestObject('Postman/emoney/opendenom Success/Checking/linkaja payment'))
