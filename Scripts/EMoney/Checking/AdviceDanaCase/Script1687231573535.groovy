...
signatureResponse = WS.sendRequest(findTestObject('Postman/Advice/Checking/GET SIGNATURE SERVICE - dana Advice Payment'))
...
danaAdviceResponse = WS.sendRequest(findTestObject('Postman/Advice/Checking/dana Payment Advice'))
