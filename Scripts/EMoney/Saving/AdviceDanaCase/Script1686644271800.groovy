...
signatureResponse = WS.sendRequest(findTestObject('Postman/Advice/Saving/GET SIGNATURE SERVICE - dana Advice Payment'))
...
danaAdviceResponse = WS.sendRequest(findTestObject('Postman/Advice/Saving/dana Payment Advice'))
