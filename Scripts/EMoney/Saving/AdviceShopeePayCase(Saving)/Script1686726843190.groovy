...
signatureResponse = WS.sendRequest(findTestObject('Postman/Advice/Saving/GET SIGNATURE SERVICE - shopeepay Advice Payment'))
...
danaAdviceResponse = WS.sendRequest(findTestObject('Postman/Advice/Saving/shopeepay Payment Advice'))
