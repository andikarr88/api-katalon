...
signatureResponse = WS.sendRequest(findTestObject('Postman/Advice/Saving/GET SIGNATURE SERVICE - Gopay Advice Payment'))
...
danaAdviceResponse = WS.sendRequest(findTestObject('Postman/Advice/Saving/gopay Payment Advice'))
