...
signatureResponse = WS.sendRequest(findTestObject('Postman/emoney/opendenom Success/Saving/GET SIGNATURE SERVICE -  emoney dana open denom inquiry'))
...
danaInquiryResponse = WS.sendRequest(findTestObject('Postman/emoney/opendenom Success/Saving/dana inquiry'))
