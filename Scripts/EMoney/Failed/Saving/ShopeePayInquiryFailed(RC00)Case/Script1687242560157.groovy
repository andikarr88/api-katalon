...
signatureResponse = WS.sendRequest(findTestObject('Postman/emoney/opendenom failed/GET SIGNATURE SERVICE -  emoney shopeepay open denom inquiry Failed (RC00)'))
...
danaInquiryResponse = WS.sendRequest(findTestObject('Postman/emoney/opendenom failed/shopeepay inquiry Failed (RC00)'))
