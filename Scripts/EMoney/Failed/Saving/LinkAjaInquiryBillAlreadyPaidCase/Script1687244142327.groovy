...
signatureResponse = WS.sendRequest(findTestObject('Postman/emoney/opendenom failed/GET SIGNATURE SERVICE -  emoney link open denom inquiry Bill Already Paid'))
...
danaInquiryResponse = WS.sendRequest(findTestObject('Postman/emoney/opendenom failed/link inquiry Bill Already Paid'))
