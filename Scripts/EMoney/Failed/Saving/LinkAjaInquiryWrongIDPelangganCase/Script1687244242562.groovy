...
signatureResponse = WS.sendRequest(findTestObject('Postman/emoney/opendenom failed/GET SIGNATURE SERVICE -  emoney link open denom inquiry Wrong ID Pelanggan'))
...
danaInquiryResponse = WS.sendRequest(findTestObject('Postman/emoney/opendenom failed/link inquiry Wrong ID Pelanggan'))
