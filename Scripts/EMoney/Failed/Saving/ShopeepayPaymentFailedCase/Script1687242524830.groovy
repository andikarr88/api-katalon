...
signatureResponse = WS.sendRequest(findTestObject('Postman/emoney/opendenom failed/GET SIGNATURE SERVICE -  - emoney shopeepay open denom payment Failed'))
...
danaPaymentResponse = WS.sendRequest(findTestObject('Postman/emoney/opendenom failed/shopeepay payment Failed'))
