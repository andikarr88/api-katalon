...
signatureResponse = WS.sendRequest(findTestObject('Postman/emoney/opendenom failed/GET SIGNATURE SERVICE -  - emoney link open denom payment Failed'))
...
danaPaymentResponse = WS.sendRequest(findTestObject('Postman/emoney/opendenom failed/link payment Failed'))
