...
signatureResponse = WS.sendRequest(findTestObject('Postman/emoney/opendenom failed/GET SIGNATURE SERVICE -  emoney link open denom inquiry Failed (RC00)'))
...
danaInquiryResponse = WS.sendRequest(findTestObject('Postman/emoney/opendenom failed/link inquiry Failed (RC00)'))
